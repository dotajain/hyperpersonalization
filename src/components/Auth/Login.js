      ...
      <div className="b">
        <div className="one-column-container">
          ...
          <div className="main-body container">
            <div className="row">
              <div className="mb-1 col-12 col-sm-8 col-md-8 col-lg-7 offset-lg-1">
                <div>
                        ...
                        <div className="panel">
                          <div className="form-group">
                            <div className="row">
                              ...
                              <div className="col-12">
                                <div className="input-xl input-group">
              ...
              <div className="col-12 col-sm-8 col-lg-3">
                <div className="need-help">
                  <h4>Need help?</h4>
                  <button type="button" onClick={(e) => handleNextPage(e, 1)} className="need-help__btn btn btn-secondary">
                    <span className="btn__text--right">
                      View All Customers
                      <svg className="btn__icon--right" width="16" height="16" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M6.5 9.775l.917.942 2.782-2.859L7.417 5l-.917.942 1.866 1.916">
